module.exports = function(RED) {
    function project(config) {
        ...
        this.on('input', async (msg) => {
            ...
            msg.payload.query.createdAt = msg.payload.query.createdAt || config.createdAt;
            msg.payload.query.createdAt1 = msg.payload.query.createdAt1 || config.createdAt1;
            ...
            msg.payload.query.updatedAt = msg.payload.query.updatedAt || config.updatedAt;
            msg.payload.query.updatedAt1 = msg.payload.query.updatedAt1 || config.updatedAt1;
            ...
            msg.payload.query.id = msg.payload.query.id || config.projectId;
            if(!msg.payload.query.id || msg.payload.query.id === ""){
                delete msg.payload.query.id;
            }

            msg.payload.query.name = msg.payload.query.name || config.projectName;
            ...
            try {
                msg.payload = await this.ozmapconnection.ozmap.read("projects", msg.payload.query);
